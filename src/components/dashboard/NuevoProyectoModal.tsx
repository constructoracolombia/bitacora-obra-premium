...
export function NuevoProyectoModal({ open, onOpenChange }: NuevoProyectoModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="border-[#D2D2D7]/60 bg-white sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-[15px] font-semibold text-[#1D1D1F]">Crear Proyecto</DialogTitle>
        </DialogHeader>
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          ...
          <p className="text-[13px] text-[#86868B]">
            Para crear o editar un proyecto, utiliza la aplicación de Finanzas. Los proyectos aparecerán automáticamente aquí.
          </p>
          <Button
            variant="outline"
